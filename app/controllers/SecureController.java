...
//		allowed = UserController.authenticate(username, password);
	...
	public static class Security extends Controller {
		...
		static void onDisconnect() {
			...
			Logger.info("User is going to be loggedout: ", user);
		}
		...
		private static Object invoke(String m, Object... args) throws Throwable {
			...
			try {
				...
				Logger.info("Global error: " + e.getMessage());
